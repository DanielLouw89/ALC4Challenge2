...
public class DealActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == PICTURE_RESULT && resultCode == RESULT_OK) {
            ...
            Glide.with(this).load(imageUri).into((ImageView) findViewById(R.id.image));
    ...
    @Override
        ...
        Log.d("Its Working", downloadPhotoUrl.toString())
     //   saveDeal();
     }});}});
...
//Uri imageUri = img;
        ...
        final StorageReference ref = FirebaseUtil.mStorageRef.child(img.toString());
